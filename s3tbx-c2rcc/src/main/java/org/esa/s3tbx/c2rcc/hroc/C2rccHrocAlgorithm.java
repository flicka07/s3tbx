...
public class C2rccHrocAlgorithm {
    ...
    // sources
    static String[] SOURCE_BAND_REFL_NAMES = new String[]{};
    static String[] NN_SOURCE_BAND_REFL_NAMES = new String[]{};
...
//    double[] thresh_rwslope = {0.95, 1.05};    // threshold for out of scope flag Rw has to be adjusted
    ...
    public static void setNnSourceBandReflNames(String[] nnSourceBandReflNames) {
        NN_SOURCE_BAND_REFL_NAMES = nnSourceBandReflNames;
    }

    public void setSourceBandReflNames(String[] sourceBandReflNames) {
...
//                double diff_log_abs_kdmin = diff_log_abs_combi_kd[4];
        ...
        return new Result(rwa, rwn, rwa_oos,
...
//        Files.
    ...
    public static class Result {
        ...
        public Result(double[] rwa, double[] rwn, double rwa_oos, double[] iops_nn,
